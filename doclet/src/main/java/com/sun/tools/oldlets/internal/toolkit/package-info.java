...
/**
    ...
    <ul>
        <li>
            ...
            {@link com.sun.tools.oldlets.internal.toolkit.AbstractDoclet}.
        </li>
        <li>
            The doclet configuration class should extend
            {@link com.sun.tools.oldlets.internal.toolkit.Configuration}.
        </li>
        <li>
            The doclet should have a writer factory that implements
            {@link com.sun.tools.oldlets.internal.toolkit.WriterFactory}.
            This class constructs writers that write doclet specific output.
        </li>
        <li>
            The doclet should have a taglet writer that extends
            {@link com.sun.tools.oldlets.internal.toolkit.taglets.TagletWriter}.
